...
========================================
Default Credentials
| Role | Credential | | Student | Any student ID (e.g. 24BCE1001) | | Admin | Password: admin123 |
...
Java Concepts Used
| Concept | Where | | OOP and encapsulation | All model classes | | Enum with methods | MealType.java | | Comparable interface | Feedback.java | | ArrayList and HashMap | FeedbackService, AnalysisService | | File I/O | FileStorage.java | | Exception handling | All service and storage classes | | LocalDate and Date API | Feedback, Alert, AlertService | | Bubble sort (manual) | FeedbackService, AnalysisService | | StringBuilder | AnalysisService.generateReport() | | Static nested enum | Alert.Severity |
